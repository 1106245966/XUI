(function() {
	...
	function Layer(html, opts) {
		...
		el.className = 'xui-select-ios-olay';
	...
	Layer.prototype = {
		...
		bindEvent: function() {
			...
			this.el.addEventListener('click', function(e) {
				self.close();
                if (document.body.classList.contains('xui-select-ios-body')) {
                    document.body.classList.remove('xui-select-ios-body');
                }
				return false;
			});
			this.el.querySelector('.layer').addEventListener('click', function(e) {
	...
	IosSelect.prototype = {
		...
		initLayer: function() {
			...
			var all_html = [
				...
				'<div class="xui-select-ios-loading-box" id="iosSelectLoadingBox">',
				    '<div class="xui-select-ios-loading"></div>',
				'</div>'
			].join('\r\n');
			this.iosSelectLayer = new Layer(all_html, {
				className: 'xui-select-ios ' + this.typeBox + (this.options.addClassName? ' ' + this.options.addClassName: ''),
			...
			document.body.classList.add('xui-select-ios-body');
			window.scrollTo(0, 0);
